  ...
  const mockNotifications = [
    {
      ...
      description:
        "Hey, I've just reviewed the documents you sent over. Everything looks good ...",
      time: "5m ago",
      unread: true,
      badge: "Urgent",
      badgeColor: "#FF9800",
    ...
    },
    {
      ...
      description:
        "You have an appointment scheduled for tomorrow, Oct 28, at 10:00 AM.",
      time: "2 days ago",
      unread: true,
    },
    {
                ...
                >
                  <Text
                    style={[
                      ...
                      {
                        color:
                          activeFilter === filter ? "#fff" : theme.colors.text,
                      },
                    ]}
                  >
                ...
                if (notification.type === "message" && notification.relatedId) {
                  router.push({
                    ...
                    params: {
                      ...
                      caseId: notification.relatedId,
                    },
                  });
                } else if (
                  notification.type === "case-update" &&
                ...
                <View style={styles.notificationTextContainer}>
                  ...
                  {notification.badge && (
                    <View
                      style={[
                        styles.badge,
                        { backgroundColor: notification.badgeColor + "20" },
                      ]}
                    >
                      <Text
                        style={[
