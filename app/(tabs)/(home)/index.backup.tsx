...
export default function HomeScreen() {
  ...
  const refreshStats = useCallback(
    (force = false) => {
      ...
      if (
        ...
        now - statsCacheRef.current.fetchedAt < 60_000
      ) {
  ...
  const navigateToPayment = (params: {
    amount: string;
    description: string;
  ...
  const importantUpdatesTitle = t("home.importantUpdates", {
    defaultValue: "Important Updates",
  });
  const paymentDescription = t("home.paymentDescription", {
    defaultValue: "Case Processing Fee",
  });
  const paymentButtonLabel = t("home.makePayment", {
  ...
  const pendingUpdateDescription = upcomingActionCase
    ? t("home.pendingActionDescription", {
        ...
        date: formatCaseDate(
          upcomingActionCase.lastUpdated || upcomingActionCase.submissionDate,
        ),
      })
  ...
  const nextAppointmentLabel = t("home.nextAppointment", {
    defaultValue: "Next Appointment",
  });
              ...
              onPress={() => {
                if (!caseForStatusCard?.referenceNumber) {
                  showAlert({
                    ...
                    message: t("home.noCaseForPayment", {
                      defaultValue: "No case is ready for payment yet.",
                    }),
