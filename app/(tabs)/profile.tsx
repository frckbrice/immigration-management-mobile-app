    ...
    async (asset: ImagePicker.ImagePickerAsset) => {
      try {
        ...
        showToast({
          ...
          message:
            error?.message ||
            t("profile.failedToChangePhoto", {
              defaultValue: "Unable to update profile photo.",
            }),
          type: "error",
        });
      } finally {
    ...
    async (mode: "camera" | "library") => {
      try {
        ...
        if (permissionStatus.status !== "granted") {
          showToast({
            title: t("profile.noPermissions", {
              defaultValue: "Permission needed",
            }),
            message: t("profile.photosPermissionNeeded", {
              defaultValue:
                "Please grant access in settings to update your profile photo.",
            }),
            type: "error",
          });
          return;
        ...
        showToast({
          ...
          message:
            error?.message ||
            t("profile.failedToChangePhoto", {
              defaultValue: "Unable to pick an image.",
            }),
          type: "error",
        });
      }
  ...
  const handleChangeProfilePhoto = useCallback(() => {
    Alert.alert(
      ...
      t("profile.choosePhotoOption", {
        defaultValue: "Choose how to upload a new photo.",
      }),
      [
            ...
            >
              ...
              >
                ...
                <View style={styles.menuTextContainer}>
                  ...
                  >
                    {t("profile.openPreferences", {
                      defaultValue: "Theme, Language & Notifications",
                    })}
                  </Text>
                  <Text
                    style={[
                  ...
                  >
                    {t("profile.preferencesRowDescription", {
                      defaultValue:
                        "Manage appearance, language and notification alerts.",
                    })}
                  </Text>
                </View>
                <IconSymbol
