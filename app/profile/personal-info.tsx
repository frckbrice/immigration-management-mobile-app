            ...
            <View style={styles.headerCopy}>
              ...
              >
                {t("profile.personalInfoSubtitle", {
                  defaultValue: "Everything we know about you in one place.",
                })}
              </Text>
            </View>
    ...
    >
      ...
      <View style={styles.summaryInfoGrid}>
        <InfoTile
          ...
          value={
            email || t("profile.addEmail", { defaultValue: "Add your email" })
          }
          theme={theme}
        />
        <InfoTile
          ...
          value={
            phone ||
            t("profile.addPhone", { defaultValue: "Add a phone number" })
          }
          theme={theme}
        />
      </View>
      ...
      <View style={styles.summaryActions}>
        ...
        <Pressable
          style={[
            ...
            { borderColor: theme.dark ? "#334155" : "#CBD5F5" },
          ]}
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        <Text style={[styles.secondaryTitle, { color: theme.colors.text }]}>
          {t("profile.securityHeadline", {
            defaultValue: "Your data stays secure",
          })}
        </Text>
        <Text
          style={[
