...
export default function PreferencesScreen() {
  ...
  const { settings, fetchSettings, updateSettings, isUpdating, setSettings } =
    useSettingsStore();
  ...
  const handleThemeChange = async (value: ThemePreference) => {
    ...
    try {
      ...
      showToast({
        ...
        message: t("profile.themeUpdated", {
          defaultValue: "Theme preference updated.",
        }),
      });
    } catch (error: any) {
      setThemePreference(settings?.themePreference ?? "system");
      ...
      showToast({
        ...
        message:
          message ||
          t("profile.themeUpdateError", {
            defaultValue: "Unable to update theme preference.",
          }),
      });
    }
  };
  ...
  const handleLanguageChange = async (value: LanguagePreference) => {
    ...
    try {
      ...
      showToast({
        type: "success",
        title: t("common.success"),
        message: t("profile.languageUpdated", {
      ...
      showToast({
        ...
        message:
          ...
          t("profile.languageUpdateError", {
            defaultValue: "Unable to change language right now.",
          }),
      });
    }
  };
      ...
      if (enabled) {
        ...
        if (!tokenData) {
          throw new Error(
            t("profile.notificationsEnableError", {
              defaultValue:
                "Unable to enable notifications. Check your device permissions and try again.",
            }),
          );
        }
        ...
        showToast({
          ...
          message: t("profile.notificationsEnabledMessage", {
            defaultValue:
              "You will now receive email and push notifications for case updates and new messages.",
          }),
        });
      } else {
        const updated = await updateSettings({
        ...
        showToast({
          type: "info",
          title: t("profile.notificationsDisabledTitle", {
            defaultValue: "Notifications Off",
          }),
          message: t("profile.notificationsDisabledMessage", {
            defaultValue:
              "Email and push alerts are silenced. You can still review new messages from the bell icon.",
          }),
        });
      }
    } catch (error: any) {
      ...
      showToast({
        ...
        message:
          ...
          t("profile.notificationsToggleError", {
            defaultValue:
              "We could not update your notification preference right now. Please try again later.",
          }),
      });
    } finally {
  ...
  const handleResetOnboarding = () => {
    Alert.alert(
      ...
      t("profile.resetOnboardingMessage", {
        defaultValue:
          "This will reset your onboarding status. You'll be taken to the welcome screens immediately. Continue?",
      }),
      [
        {
            ...
            try {
              ...
              showToast({
                ...
                message: t("profile.onboardingResetSuccess", {
                  defaultValue:
                    "Onboarding reset. Redirecting to getstarted screens...",
                }),
              });
              ...
              showToast({
                ...
                message:
                  error?.message ||
                  t("profile.onboardingResetError", {
          ...
          <View style={styles.headerTextContainer}>
            <Text style={[styles.headerTitle, { color: colors.text }]}>
              {t("profile.preferencesTitle", {
                defaultValue: "Theme & Language",
              })}
            </Text>
            <Text style={[styles.headerSubtitle, { color: colors.muted }]}>
              {t("profile.preferencesSubtitle", {
                defaultValue:
                  "Personalize how the app looks and the language you read.",
              })}
            </Text>
          </View>
            ...
            <View style={styles.cardHeader}>
              <View style={styles.cardHeaderText}>
                <Text style={[styles.cardTitle, { color: colors.text }]}>
                  {t("profile.notificationSectionTitle", {
                ...
                <Text style={[styles.cardSubtitle, { color: colors.muted }]}>
                  {t("profile.notificationSectionSubtitle", {
                    defaultValue:
                      "Enable email and push alerts for new messages and case updates.",
                  })}
                </Text>
              </View>
            </View>
                  ...
                  <View style={styles.toggleTextContainer}>
                    ...
                    >
                      {t("profile.notificationsDescription", {
                        defaultValue:
                          "Enable alerts for new messages and case updates.",
                      })}
                    </Text>
                  </View>
                </View>
