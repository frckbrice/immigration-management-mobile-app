    ...
    try {
      ...
      const errorMessage =
        ...
        t("profile.exportErrorMessage", {
          defaultValue:
            "We couldn’t start the export. Please try again shortly.",
        });
          ...
          <View style={styles.headerTextContainer}>
            ...
            <Text style={[styles.headerSubtitle, { color: colors.muted }]}>
              {t("profile.exportSubtitle", {
                defaultValue:
                  "Request a copy of your personal data for your records.",
              })}
            </Text>
          </View>
          ...
          >
            <View style={styles.cardHeader}>
              ...
              <View style={styles.cardTextContainer}>
                <Text style={[styles.cardTitle, { color: colors.text }]}>
                  {t("profile.exportCardTitle", {
                    defaultValue: "Request your personal data",
                  })}
                </Text>
            ...
            >
              {exporting ? (
                ...
                >
                  {t("profile.exportCta", {
                    defaultValue: "Submit export request",
                  })}
                </Text>
              )}
            </Pressable>
