...
const SearchField = forwardRef<TextInput, SearchFieldProps>(
    ({ containerStyle, onClear, showClear = true, style, value, ...rest }, ref) => {
            ...
            <View
                style={[
                    styles.container,
                    {
                        ...
                        borderColor: withOpacity(colors.borderStrong, theme.dark ? 0.50 : 0.7),
                    },
                    containerStyle,
                ]}
            >
                ...
                {showClear && hasValue && (
                    <Pressable style={styles.clearButton} onPress={onClear}>
                        <IconSymbol name="xmark.circle.fill" size={18} color={withOpacity(colors.text, 0.35)} />
                    </Pressable>
                )}
            </View>
        );
